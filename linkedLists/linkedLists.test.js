...
describe('#getByIndex', () => {
    ...
    describe('with index from middle of list', () => {
        test('it returns the head', () => {
...
describe('#insertAtIndex', () => {
    ...
    describe('with index from middle of list', () => {
        test('it inserts at index given', () => {
            const ll = LinkedList.fromValues(10, 20, 30, 40);
...
describe('#removeHead', () => {
    test('removes head from linked list', () => {
...
describe('#removeAtIndex', () => {
    ...
    describe('with index from middle of list', () => {
        test('it removes at index given', () => {
            const ll = LinkedList.fromValues(10, 20, 30, 40);
            ll.removeAtIndex(2)
